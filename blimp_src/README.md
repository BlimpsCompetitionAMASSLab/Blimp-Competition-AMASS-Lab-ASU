...
│   │
│   ├── recorded data storage/                   # Test data & logs
│   │   ├── client.py                           # Data client utility
│   │   ├── data_record_*.txt                   # Sample recorded data
│   │   ├── PI_Data_*.txt                       # Recorded PI controller data
│   │   ├── vicom_test_*                        # Vicon motion capture test data
│   │   └── test_data/                          # Test dataset directory
│   │
│   └── __pycache__/                            # Python cache (ignore)
├── bag_files                                    # Contains recorded topics
...
### 4. **controls** - Motor & Control Driver Nodes
...
### 5. **manual_control** - Joystick Input Handling
...
### 6. **launch** - Launch Files (Entry Points)
